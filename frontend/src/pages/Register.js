...
import { Eye, EyeOff, Sprout, Mail, Lock, User, Phone, MapPin, Home, Wheat, TreePine, Sun } from 'lucide-react';
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <h1 className="text-5xl font-bold mb-4">
                  Join AgriAI Platform
                </h1>
                <p className="text-xl text-white/90 leading-relaxed">
                  Start your smart farming journey today. Get AI-powered recommendations 
                  for optimal crop selection and fertilizer management.
                </p>
              </div>
              ...
              <div className="space-y-4 text-left max-w-md mx-auto">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Increase Yield</h3>
                      <p className="text-sm text-white/80">Data-driven decisions for better harvests</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Save Resources</h3>
                      <p className="text-sm text-white/80">Optimized fertilizer and water usage</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/80">No subscription fees or hidden costs</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <p className="text-sm text-gray-600 mb-3 font-medium">Optional Information</p>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="tel"
                          {...register('phone')}
                          className="appearance-none block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1">
                  Fill any valid information to test the platform instantly
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Footer */}
            <div className="mt-8 text-center">
              <p className="text-xs text-white/80">
                Join thousands of farmers already using AI to optimize their harvests
              </p>
            </div>
          </div>
        </div>
